 ...
 * Sun Aug 11 2019 11:03:34 GMT+0300 (Москва, стандартное время)
...
info_style = ['','position: absolute;','padding: 20px;','background-color: #AA22FF;','color: white;','transition: opacity 0.6s;','left: 0px;','right: 0px;','font-family: sans-serif;','bottom: 0px;','text-align: center;','font-weight: bold;','float: right;','cursor: pointer;','transition: 0.3s;'].join('');
...
registerOnHover(["ALL_OBJECTS"], function() {
  if (_pGlob.hoveredObject == "_dome") {
    ...
    if (!dictGet(getObjCustomProps(_pGlob.hoveredObject), 'prop')) {
      ...
      setHTMLElemAttribute('style', [info_style,['font-size: ',tmp,'px;'].join(''),['font-size: ',tmp,'px;'].join(''),'opacity: 0.5;'].join(''), 'info', false);
    }
  }
}, function() {
  setHTMLElemStyle('cursor', 'default', ["BODY"], false);
