 ...
 * Sat Aug 17 2019 21:03:00 GMT+0300 (Москва, стандартное время)
...
var undefined2, info_style, obj, data_muz, tmp;
...
function ORDER_HOVER() {
  registerOnHover(["ALL_OBJECTS"], function() {
    if (_pGlob.hoveredObject == "$1_DOME") {
      ...
      tmp = Math.ceil(Math.min.apply(null, [getHTMLElemAttribute('innerHeight', ["WINDOW"], false), getHTMLElemAttribute('innerWidth', ["WINDOW"], false)]) / 100);
...
function START_INTRO() {
  ...
  setHTMLElemAttribute('style', ['position: absolute;','padding: 50px; border-radius: 25px;','background-color: #EEEEDD;','color: #FF9922; text-shadow: 2px 2px 2px #000000, 0 0 3px #000000;','opacity: 1;','','left: 50px;','right: 50px;','bottom: 50px;','font-family: sans-serif;','text-align: center;','font-size: 72px;','box-shadow: 0 0 15px 12px rgba(0,0,0,0.6);','background: linear-gradient(to top, #3355AA, #113377); line-height: 0.3; border: 5px solid  #3355AA;',''].join(''), 'intro', false);
}


undefined2 = getJSFunction('setundefined')();
data_muz = {};
...
changeVis("coin", false);
changeVis("Point", false);
changeVis("Point.001", false);

START_INTRO();
eventHTMLElem('click', 'intro', false, function(event) {
  setHTMLElemStyle('opacity', '0', 'intro', false);
  ORDER_HOVER();
});
