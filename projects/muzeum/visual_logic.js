 ...
 * Sat Aug 10 2019 23:40:01 GMT+0300 (Москва, стандартное время)
...
registerOnHover(["ALL_OBJECTS"], function() {
  ...
  if (getHTMLElemAttribute('id', 'alert', false) != 'alert') {
    addHTMLElement('div', 'alert');
  }
  if (!dictGet(getObjCustomProps(_pGlob.hoveredObject), 'prop')) {
    setHTMLElemAttribute('innerHTML', '', 'alert', false);
    setHTMLElemAttribute('style', 'opacity: 0.0;', 'alert', false);
  } else {
    setHTMLElemAttribute('innerHTML', String('<span id="close_btn">&times;</span>') + String(dictGet(getObjCustomProps(_pGlob.hoveredObject), 'prop')), 'alert', false);
    setHTMLElemAttribute('style', ['position: absolute;','padding: 20px;','background-color: #AA22FF;','color: white;','opacity: 0.5;','transition: opacity 0.6s;','left: 0px;','right: 0px;','bottom: 0px;','font-family: sans-serif;','text-align: center;'].join(''), 'alert', false);
    setHTMLElemAttribute('style', ['font-weight: bold;','float: right;','font-size: 36px;','line-height: 20px;','cursor: pointer;','transition: 0.3s;'].join(''), 'close_btn', false);
    updateTextObj("_panel_main_text", dictGet(getObjCustomProps(_pGlob.hoveredObject), 'prop'));
  }
}, function() {
  setHTMLElemStyle('cursor', 'default', ["BODY"], false);
  outline(_pGlob.hoveredObject, "DISABLE");
